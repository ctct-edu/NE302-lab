...
本マニュアルはCTCテクノロジー主催「[AI ペアプログラミング実践](https://www.school.ctc-g.co.jp/course/NE302.html)」のラボマニュアルになります。



## マニュアルの見かた

講師の指示に従い、「**[LabManual](https://github.com/ctct-edu/NE302-lab/tree/main/LabManual)**」のフォルダへ移動してください。
