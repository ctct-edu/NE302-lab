...
const inventoryService = new InventoryService(inventoryRepository, transactionRepository, productRepository)
...
router.post('/:productId/in', async (req: Request, res: Response) => {
  try {
    ...
    const inventory = await inventoryService.updateStock(productId, quantity, TransactionType.IN, note)
...
router.post('/:productId/out', async (req: Request, res: Response) => {
  try {
    ...
    const inventory = await inventoryService.updateStock(productId, quantity, TransactionType.OUT, note)
